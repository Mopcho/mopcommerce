...
export const SingleItem: FC<{ title: string, price: number, imageUrl: string }> = ({ title, price, imageUrl }) => {
    return (
        <div className="flex flex-col mb-6">
            <img src={imageUrl} alt="Tea" className="object-cover w-[200px] h-[200px] hover:opacity-70 hover:cursor-pointer scale-95 hover:scale-100 ease-in duration-100"></img>
